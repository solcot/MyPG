...
--------------+-----------+-----------+----------------+--------------------
         1045 |       366 |       679 |           1.09 |           11424707
* 매도: ma10*0.97
* 매수: sm.change_rate < 12.0
 총 매매 횟수 | 익절 횟수 | 손절 횟수 | 평균 수익률(%) | 총 합산 손익금(원)
--------------+-----------+-----------+----------------+--------------------
         1040 |       365 |       675 |           1.11 |           11579282
* 매도: ma10*0.97
* 매수: sm.change_rate < 10.0
 총 매매 횟수 | 익절 횟수 | 손절 횟수 | 평균 수익률(%) | 총 합산 손익금(원)
--------------+-----------+-----------+----------------+--------------------
         1024 |       362 |       662 |           1.21 |           12399221
* 매도: ma10*0.97
* 매수: sm.change_rate < 7.0
 총 매매 횟수 | 익절 횟수 | 손절 횟수 | 평균 수익률(%) | 총 합산 손익금(원)
--------------+-----------+-----------+----------------+--------------------
          962 |       338 |       624 |           1.25 |           12010420
* 매도: ma10*0.97
