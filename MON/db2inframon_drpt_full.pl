...
#use strict;
use warnings; 
# ex) perl ./db2inframon_drpt_full.pl -c 5 -u 2 -t 10 -x ./package.sh -y ./package.sh -n ./package_header.sh -l ./package_log.sh -q 2 -e -o /work3/db2/V11.5.dc_inshome/jhkim/MONITOR/LOG_PERL
